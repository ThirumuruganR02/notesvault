...
public class NoteService {
    ...
    public List<Note> findAllForUser(Long userId, String tagFilter, String searchQuery) {
        ...
        log.info(
                ...
                userId, notes.size(), hasTag, searchTerm.isPresent()
        );
    ...
    public Note create(Long userId, NoteRequest request) {
        ...
        log.info(
                ...
                userId, saved.getId(), saved.getTitle().length(), saved.getTags().size()
        );
    ...
    public Optional<Note> update(Long userId, Long noteId, NoteRequest request) {
        ...
        Optional<Note> updated = noteRepository.findByIdAndOwner(noteId, owner).map(note -> {
        ...
        if (updated.isPresent()) {
            ...
            log.info(
                    ...
                    userId, n.getId(), n.getTitle().length(), n.getTags().size()
            );
        } else {
